...
def create_eyewear(*args, **kwargs):
    ...
    ipdLeft=32.0,ipdRight=32.0,bridge=22,lens=49,temple=150,distance="3km away", notes="Very fancy frames", image="../images/shop-glasses.jpg", price=9.99))
    db.session.add(EyeWear(id=2, sphereLeft = -1.50, sphereRight= -2.00,
    ipdLeft=30.0,ipdRight=32.0,bridge=25,lens=55,temple=152,distance="2km away", notes="My head grew :(",image="../images/shop-glasses2.jpg", price=4.99))
    db.session.commit()
