      ...
      <div style={{ width: "80%", margin: "auto", marginTop: "40px" }}>
        <div className="row individual-results">
          <div className="col-lg-6 img-container">
            <img src={glass.image} alt="Glasses" className="img-fluid"></img>
            <br />
            <br />
            <button className="btn btn-branding">Message</button>{" "}
            <button className="btn btn-branding">Purchase</button>
          </div>
          ...
          <div className="col-lg-6 glasses-detail">
            <div className="row">
              <div className="col-lg-4">
                ...
                <div class="container">
                  <div class="flex-item">
                    Left: {glass.sphereLeft}
                    <br />
                    Right: {glass.sphereRight}
                  </div>
                  {similarity ? (
                    <div class="flex-item ">
                      Yours: {yours.sphereLeft}
                      <br />
                      Yours: {yours.sphereRight}
                    </div>
                  ) : null}
                </div>
              </div>
              ...
              <div className="col-lg-4">
                ...
                <div class="container">
                  <div class="flex-item your-results">
                    Bridge: {glass.bridge}
                    <br />
                    Lens:
                    <br />
